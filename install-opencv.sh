...
log "Baixando a biblioteca OpenCV 2.4.9"
...
wget https://github.com/opencv/opencv/archive/2.4.9.zip -O opencv-2.4.9.zip
 
# Extrai o conteúdo
unzip opencv-2.4.9.zip

log "Instalando a biblioteca OpenCV 2.4.9"
...
log "OpenCV 2.4.9 foi instalado com sucesso!"
