    ...
    ui(new Ui::LogWindow)
{
    ...
    ui->tableWidget->setVerticalHeaderLabels(QStringList() << "Time" << "m1_velocity" << "m2_velocity" << "m3_velocity"
                                             ...
                                             << "Vref" << "Vnref" << "Wref"
                                             << "Xr" << "Yr" << "Teta"
                                             << "Xr_Odom" << "Yr_Odom" << "Teta_Odom"
                                             << "X_v1" << "Y_v1" << "Teta_v1" << "id_v1"
                                             << "X_v2" << "Y_v2" << "Teta_v2" << "id_v2");
...
void LogWindow::updateTable(ros_gui::RX_data pkg_data)
{
    ...
    ui->tableWidget->setItem(27,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Vref)));
    ui->tableWidget->setItem(28,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Vnref)));
    ui->tableWidget->setItem(29,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Wref)));
    ui->tableWidget->setItem(30,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.X_robot)));
    ui->tableWidget->setItem(31,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Y_robot)));
    ui->tableWidget->setItem(32,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Theta_robot)));
    ui->tableWidget->setItem(33,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.X_robot_Odom)));
    ui->tableWidget->setItem(34,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Y_robot_Odom)));
    ui->tableWidget->setItem(35,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Theta_robot_Odom)));
    ui->tableWidget->setItem(36,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.X_v1)));
    ui->tableWidget->setItem(37,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Y_v1)));
    ui->tableWidget->setItem(38,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Theta_v1)));
    ui->tableWidget->setItem(39,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.id_v1)));
    ui->tableWidget->setItem(40,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.X_v2)));
    ui->tableWidget->setItem(41,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Y_v2)));
    ui->tableWidget->setItem(42,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.Theta_v2)));
    ui->tableWidget->setItem(43,ui->tableWidget->columnCount()-1,new QTableWidgetItem(QString::number(pkg_data.id_v2)));
